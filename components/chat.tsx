...
export function Chat({
  ...
  // Use the domain prop if provided, otherwise fall back to context
  ...
  // Track if chat has started (has messages)
      ...
      <div className="overscroll-behavior-contain flex h-dvh min-w-0 touch-pan-y flex-col bg-background">
        ...
        <AnimatePresence mode="wait">
          {hasMessages ? (
            ...
            // Centered view when no messages - inspired by Milo design
            <motion.div
              key="welcome-view"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            <div className="w-full max-w-4xl space-y-6">
              ...
              {/* Search Input with Suggested Actions */}
              <div className="mx-auto w-full max-w-3xl space-y-4">
                {!isReadonly && (
                  <MultimodalInput
                    ...
                    onModelChange={setCurrentModelId}
                    usage={usage}
                    placeholder={activeDomain === 'FINANCE' ? 'Ask about investment banking, private equity...' : 'Describe your dream job'}
